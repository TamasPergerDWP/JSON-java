...
public class JSONObjectTest {
    ...
    public void jsonObjectParsingErrors() {
        ...
        try {
            // too deep nesting, allowed maxNestingDepth = 42
            int depth = 6000;
            String open = "{\"a\":";
            String value = "false";
            String close = "}";
            ...
            assertNull("Expected an exception",new JSONObject(wayTooDeepJSON, maxNestingDepth));
        } catch (JSONException e) {
    ...
    public void testMaxNestingDepthIsRespectedWithValidJSON() {
        ...
        try {
            assertNull("Expected an exception",new JSONObject(tooDeepJSON, maxNestingDepth));
        } catch (JSONException e) {
            assertTrue("Wrong throwable thrown: not expecting message <" + e.getMessage() + ">",
                e.getMessage().startsWith("Maximum nesting depth of " + maxNestingDepth));
        }
    ...
    public void testMaxNestingDepthWithValidFittingJSON() {
        ...
        final int maxNestingDepth = 2;

        try {
            new JSONObject(perfectlyFineJSON, maxNestingDepth);
        } catch (JSONException e) {
            e.printStackTrace();
